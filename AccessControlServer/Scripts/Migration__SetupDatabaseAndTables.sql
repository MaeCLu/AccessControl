...
IF NOT EXISTS (SELECT * FROM sysobjects WHERE Name = 'AccessControl' And Type in (N'U'))
BEGIN
...
IF 0 = (SELECT COUNT(*) FROM AccessControl )
    DECLARE @i int
    SET @i = 1
	WHILE(@i <= 30)
	BEGIN
		INSERT INTO [AccessControl]([Message], [Details]) VALUES(CONCAT('Test Event ', @i), CONCAT('Running Event ', @i))
		SET @i = @i + 1
	END
GO